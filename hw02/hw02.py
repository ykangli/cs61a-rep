...
def count_coins(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def helper_find(total, smallest_coin):      
        if total == 0:
            return 1
        if total < 0:
            return 0
        if smallest_coin == None:
            return 0
        with_coin = helper_find(total - smallest_coin, smallest_coin)
        without_coin = helper_find(total, next_largest_coin(smallest_coin))    
        return without_coin + with_coin
    return helper_find(total, 1)
